...
"")
        ...
        # self.import_item_btn = QtWidgets.QPushButton(parent=self.widget_2)
        # self.import_item_btn.setMinimumSize(QtCore.QSize(60, 25))
        # self.import_item_btn.setObjectName("add_item_btn")
        # self.horizontalLayout_2.addWidget(self.import_item_btn)
    ...
    def retranslateUi(self, add_item):
        ...
        # self.import_item_btn.setText(_translate("add_item", "Import item"))
