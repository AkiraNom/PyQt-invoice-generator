...
class InvoiceData():
    def __init__(self,company,companyAddress,table,logo,subtotal,discount,vat_rate,vat,total,client,clientAddress,invoiceNumber):
        ...
        page.drawRightString(480, line_y-60, "Discount :")
        page.line(480, line_y-63, 560, line_y-63)
        page.drawRightString(480, line_y-85, f"VAT ({vat_rate}%) :")
        page.line(480, line_y-88, 560, line_y-88)
        page.setFont("Helvetica-Bold", 16)
        page.drawRightString(480, line_y-110, "Total :")
        page.line(480, line_y-113, 560, line_y-113)

        page.setFont("Helvetica-Bold", 10)
        page.setFillColor(HexColor(highlight_font_color))
        page.drawRightString(551, line_y-35, f"${subtotal}")
        page.drawRightString(551, line_y-60, f"-${discount}")
        page.drawRightString(551, line_y-85, f"${vat}")
        page.setFont("Helvetica-Bold", 16)
        page.drawRightString(551, line_y-110, f"${total}")
