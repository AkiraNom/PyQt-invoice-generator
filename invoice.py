...
"}")
        ...
        self.vat = QtWidgets.QLineEdit(parent=self.frame_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.vat.sizePolicy().hasHeightForWidth())
        self.vat.setSizePolicy(sizePolicy)
        self.vat.setMinimumSize(QtCore.QSize(0, 25))
        self.vat.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.vat.setText("7.50")
        self.vat.setObjectName("vat rate(%)")
        self.horizontalLayout_16.addWidget(self.vat)
