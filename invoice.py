...
"}")
        ...
        self.save_btn = QtWidgets.QPushButton(parent=self.headerInvoiceFrame)
        self.save_btn.setMinimumSize(QtCore.QSize(0, 25))
        self.save_btn.setMaximumSize(QtCore.QSize(100, 30))
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("./icon/save.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("./icon/clear-symbol.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.clear_btn.setIcon(icon4)
        self.clear_btn.setObjectName("clear_btn")
        self.horizontalLayout_4.addWidget(self.clear_btn)
        self.close_btn = QtWidgets.QPushButton(parent=self.headerInvoiceFrame)
        self.close_btn.setMinimumSize(QtCore.QSize(0, 25))
        ...
        self.n_invoice.setText("AAA-0035")
