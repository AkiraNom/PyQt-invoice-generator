...
"}")
        ...
        self.companyName.setText("Supplier Company INC")
        ...
        self.companyPhone.setText("234-231-415")
        ...
        self.companyEmail.setText("suppliercompany@supplier.com")
        ...
        self.companyAddress.setText("6622 Abshire Mills Port Orlofurt, 05820 United States")
        ...
        self.vat_rate = QtWidgets.QLineEdit(parent=self.frame_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.vat_rate.sizePolicy().hasHeightForWidth())
        self.vat_rate.setSizePolicy(sizePolicy)
        self.vat_rate.setMinimumSize(QtCore.QSize(0, 25))
        self.vat_rate.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.vat_rate.setText("7.50")
        self.vat_rate.setObjectName("vat rate(%)")
        self.horizontalLayout_16.addWidget(self.vat_rate)
